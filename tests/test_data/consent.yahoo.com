...
<html dir="ltr" class="ltr eu yahoo-page height100">
    <head>
        <title>Yahoo is now a part of Oath</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" >
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no, viewport-fit=cover">
        <link rel="stylesheet" href="https://s.yimg.com/oa/build/css/site-ltr-5cb48a68.css">
    ...
    <body class="no-js no-touch blur-preview-tpl eu-localized  en">
        ...
        <div class="consent-container">
            ...
            <div class="consent-text">
                ...
                <a class="expand-learn-more">Learn More.</a>
                <section class="learn-more-content hidden">
                    <h2>How Oath and our partners bring you better ad experiences</h2>
                    <p>
